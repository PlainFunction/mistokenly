...
const (
	AuditService_LogAccess_FullMethodName    = "/audit.AuditService/LogAccess"
	AuditService_GetAuditLogs_FullMethodName = "/audit.AuditService/GetAuditLogs"
	AuditService_HealthCheck_FullMethodName  = "/audit.AuditService/HealthCheck"
)
...
type AuditServiceClient interface {
	LogAccess(ctx context.Context, in *LogAccessRequest, opts ...grpc.CallOption) (*LogAccessResponse, error)
...
func (c *auditServiceClient) LogAccess(ctx context.Context, in *LogAccessRequest, opts ...grpc.CallOption) (*LogAccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogAccessResponse)
	err := c.cc.Invoke(ctx, AuditService_LogAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuditServiceServer interface {
	LogAccess(context.Context, *LogAccessRequest) (*LogAccessResponse, error)
...
func (UnimplementedAuditServiceServer) LogAccess(context.Context, *LogAccessRequest) (*LogAccessResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LogAccess not implemented")
}
...
func _AuditService_LogAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LogAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuditServiceServer).LogAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuditService_LogAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServiceServer).LogAccess(ctx, req.(*LogAccessRequest))
	}
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "LogAccess",
			Handler:    _AuditService_LogAccess_Handler,
		},
		{
